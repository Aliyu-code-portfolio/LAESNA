...
This is the first user interface a users encounter. Users can navigate between LOGIN or REGISTER, new users are required to provide important details, including details of their health condition which will only be used in response to a medical emergency.
...
After successfully logging in, Users are prompted for permission to use their device location, this must be Allowed for LAESNA to get the exact location of a User during an emergency
...
- By pressing and holding the animated panic button after which LAESNA will do it's magic and send your accurate location to the specified emergency team in seconds.
## LAESNA Chat Screen
...
The chat feature of LAESNA provide User with added functonality of been able to ask quick question and get answers from the Emergency teams available

## Choose your Emergency
<img src="https://user-images.githubusercontent.com/88856370/183697085-4a6ff7c3-080e-4e77-b1c5-4e6d1829366c.jpg" width="200" height="450"/>
After a User presses the animated panic buttton this screen shows up to confirm the type of emergency
